...
add_custom_command(OUTPUT ${INTERMEDIATE_LICENCE_H}
  COMMAND ${CMAKE_COMMAND}
    -DLICENCE_FILE=${CMAKE_SOURCE_DIR}/external/putty/0.78/LICENCE
    -DOUTPUT_FILE=${INTERMEDIATE_LICENCE_H}
    -P ${CMAKE_SOURCE_DIR}/external/putty/0.78/cmake/licence.cmake
  DEPENDS ${CMAKE_SOURCE_DIR}/external/putty/0.78/cmake/licence.cmake ${CMAKE_SOURCE_DIR}/external/putty/0.78/LICENCE)
...
add_custom_target(check_git_commit
  ...
  COMMAND ${CMAKE_COMMAND}
    ...
    -DOUTPUT_TYPE=header
    -P ${CMAKE_SOURCE_DIR}/external/putty/0.78/cmake/gitcommit.cmake
  DEPENDS ${CMAKE_SOURCE_DIR}/external/putty/0.78/cmake/gitcommit.cmake
  WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/external/putty/0.78
...
function(be_list TARGET NAME)
  ...
  add_library(${TARGET}-be-list OBJECT ${CMAKE_SOURCE_DIR}/external/putty/0.78/be_list.c)
